...
export const config: TwoPageSheetConfig = {
  ...
  sheetId: 'fr-v1-humain',
  pageConfig: {
    pages: [ 'humain-1.png', 'humain-2.png' ],
    pageFormat: 'A4',
  ...
  content: {
    ...
    page1: [
        ...
        { key: 'qualites', x: 7, y: 44.4, width: 33.4, height: 4.7, type: 'text-zone'},
        { key: 'defaults', x: 58.6, y: 44.4, width: 33.4, height: 4.7, type: 'text-zone'},

        ...skill('artisanat', 53.00, skills => half(skills.physique.oeil+skills.mental.vibrisse), 1),
        ...skill('archeologie', 54.47, skills => skills.mental.ronron, 1),
        ...skill('arme-a-feu', 55.94, skills => skills.physique.oeil),
        ...skill('arme-de-jet', 57.41, skills => skills.physique.oeil),
        ...skill('arme-blanches', 58.88, skills => skills.physique.queue),
        ...skill('art-martial', 60.35, skills => half(skills.physique.queue+skills.physique.griffe),1),
        ...skill('bricolage', 61.82, skills => half(skills.physique.oeil + skills.mental.ronron)),
        ...skill('culture-generale', 63.29, skills => skills.mental.ronron),
        ...skill('combat-a-mains-nues', 64.76, skills => half(skills.physique.griffe+skills.physique.poil)),
        ...skill('commerce', 66.23, skills => half(skills.mental.ronron+skills.physique.poil)),
        ...skill('conduite-de-vehicules', 67.70, skills => skills.mental.ronron),
        ...skill('connaissance-de-la-rue', 69.17, skills => half(skills.mental.ronron+skills.mental.coussinet)),
        ...skill('deguisement', 70.64, skills => skills.physique.oeil),
        ...skill('discretion', 72.11, skills => skills.physique.queue),
        ...skill('droit-et-administration', 73.58, skills => skills.mental.ronron, 1),
        ...skill('equitation', 75.05, skills => half(skills.mental.vibrisse+skills.physique.queue)),
        ...skill('escalade', 76.52, skills => half(skills.physique.queue+skills.physique.griffe)),
        ...skill('langage-natale', 77.99, skills => skills.mental.ronron),
        ...skill('langage-etrangere', 79.46, skills => skills.mental.ronron, 1),
        ...skill('leadership', 80.93, skills => skills.mental.caresse),
        ...skill('navigation', 82.40, skills => skills.mental.ronron),
        ...skill('orientation', 83.87, skills => skills.mental.vibrisse),
        ...skill('persuation', 85.34, skills => half(skills.mental.caresse+skills.mental.coussinet)),
        ...skill('psychologie-feline', 86.81, skills => half(skills.mental.ronron+skills.mental.vibrisse)),
        ...skill('saut', 88.28, skills => skills.physique.queue),
        ...skill('secourisme', 89.75, skills => skills.mental.ronron, 1),
        ...skill('seduire', 91.22, skills => skills.mental.coussinet),
        ...skill('survie', 92.69, skills => half(skills.mental.ronron+skills.mental.vibrisse)),
        ...skill('trouver-un-objet-cache', 94.16, skills => half(skills.mental.caresse+skills.mental.vibrisse)),
        ...skill('us-et-coutumes-humaines', 95.63, skills => skills.mental.ronron, 1),

        { key: 'critiques', x: 78.0, y: 51.4, width: 14.1, height: 45.4, type: 'text-zone'},
      ],
    page2: [
